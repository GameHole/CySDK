...
public class AndroidLibCallback : MonoBehaviour
{
    ...
    public void onAdClosed(params string[] args)
    {
        ...
        {
            IBannerListener bannerListener = (IBannerListener)AdHelper.getInstance().loadListeners[type - 1];
    ...
    public void onUserEarnedReward(params string[] args)
    {
        ...
        {
            IRewardShowListener rewardShowListener =  (IRewardShowListener)AdHelper.getInstance().showListeners[(int)AdType.AD_REWARD - 1];
