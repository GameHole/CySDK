...
public class AdHelper
{
    ...
    public ILoadListener[] loadListeners = new ILoadListener[4];
    public IShowListener[] showListeners = new IShowListener[4];
     ...
     */
    public static void showBanner(IBannerListener bannerListener, int startMargin, int endMargin, int bottomMargin, Horizon horizMode = Horizon.HORIZ_MODEL_CENTER)
    {
     ...
     */
    public static void showInterstitial(IShowListener listener, bool showWhenLoaded = true)
    {
     ...
     * showWhenLoaded 仅在广告预加载完成时展示广告，如果未加载完成，则跳过此次展示时机
     */
    public static void showReward(IRewardShowListener listener, bool showWhenLoaded = true)
    {
     ...
     * showWhenLoaded 仅在广告预加载完成时展示广告，如果未加载完成，则跳过此次展示时机
     */
    public static void showFloat(IShowListener listener, int startMargin, int endMargin, int bottomMargin, Horizon horizMode = Horizon.HORIZ_MODEL_CENTER, bool showWhenLoaded = true)
    {
     ...
     */
    public static void loadFloat(ILoadListener listener)
    {    
     ...
     *listener 预加载过程中一些状态或者结果的回调
     */
    public static void loadInterstitial(ILoadListener listener)
    {
     ...
     *listener 预加载过程中一些状态或者结果的回调
     */
    public static void loadReward(ILoadListener listener)
    {
